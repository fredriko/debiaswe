...
if __name__ == "__main__":
    ...
    root = Path(Path.home(), Path("Dropbox/RISE/research/bias-nlp-2019/data/models/normalized-vocabulary-models")).resolve()
    ...
    model = WordEmbedding(str(w2v_model_file), model_type="word2vec", max_size_voc=50000)
